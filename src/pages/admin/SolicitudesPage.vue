      ...
      <q-table :rows="solicitudes" :columns="columns" row-key="id" :loading="loading" v-model:pagination="pagination"
        ...
        <template v-slot:body-cell-estado="props">
          <q-td :props="props">
            ...
            <q-icon v-if="props.row.documento_entregado" name="check_circle" color="positive" size="xs" class="q-ml-xs">
      ...
      <q-card>
        <q-card-section class="row items-center bg-primary text-white no-print">
          ...
          <q-btn icon="close" flat round dense v-close-popup />
                ...
                <q-card-section v-if="datosFormulario">
...
import FormularioOficial from '@/components/FormularioOficial.vue'
